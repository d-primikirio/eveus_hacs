...
- Відображення статусу зарядної станції та лімітів
- Сенсори в реальному часі: потужність (Вт), напруга, струм, температура, напруга вбудованої батарейки
- Виявлення підключення авто
